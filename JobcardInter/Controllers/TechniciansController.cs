...
namespace JobcardInter.Controllers
{
    public class TechniciansController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TechnicianID,TechFullName,IdNumber,ContactNumber,EmailAddress,area")] Technician technician)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TechnicianID,TechFullName,IdNumber,ContactNumber,EmailAddress,area")] Technician technician)
        {
            if (ModelState.IsValid)
            {
